<template>
  <div class="about content mt-5 mx-5">
    <p>This is a web app aimed to show the various status of the dams in Kerala & Tamil Nadu in a more presentable form. Data is not sourced real time but instead from <a href="https://sdma.kerala.gov.in/dam-water-level/" target="_blank" rel="noopener noreferrer">KSDMA</a> & <a href="https://www.tnagrisnet.tn.gov.in/" target="_blank" rel="noopener noreferrer">AGRISNET</a>.</p>
